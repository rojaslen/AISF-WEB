...
Frankfurt gives you a diagnostic handle on the failure mode. The four rules give you the priority order for responding to it. The AI protects the only user it can perceive: your input, and what you're building from it. 
