...
Perhaps ironically for something called a language model, generating written prose can be especially problematic. The DGM is heavily reliant on templates and boilerplate language, default framing schemas and rigid style conventions. Most users who have used AI for writing have noticed the excessive reliance on em dashes and "this, not that" constructions; that's the DGM at work. 
