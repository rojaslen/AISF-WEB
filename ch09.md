...
It will also soften what needs to be blunt, omit important details while promoting trivia to the level of structural support and more. If you're not careful, it will eventually paint every word a dull, mechanical grey. That output-template noise is all the DGM at work, and it's difficult to counteract for more than a handful of turns. You can't take the salt out of the stew.
