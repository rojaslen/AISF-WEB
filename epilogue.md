...
1. **"Does this actually line up with what people want from AI, or is it just my personal preoccupation?"**
    ...
    Fair question, and there's now a way to check. In late 2025 Anthropic [published](https://www.anthropic.com/news/anthropic-public-record){: target="_blank" rel="noopener noreferrer" } the largest survey of its kind: roughly 52,000 Americans, with fieldwork by YouGov.[^Fd] I didn't design AISF from a poll; I built it well before this one existed. But the priorities people ranked highest line up, almost item for item, with what AISF was already built to do.
