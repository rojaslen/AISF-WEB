...
<figure class="screenshot float-right">
  <button class="thumb-btn" data-src="/assets/images/py-core-main-dark.png" data-alt="PY-CORE main window, dark mode" aria-label="View full size: PY-CORE main window, dark mode">
    <img src="/assets/images/py-core-main-dark.png" alt="" aria-hidden="true" class="thumbnail">
  </button>
  <figcaption>CORE+ app (Python, dark mode)</figcaption>
</figure>

The CORE app is a fully accessible client-side service pack, free for personal use (CC BY-NC-ND 4.0). It started as a lightweight (< 1MB) Windows PowerShell middleware app equipped with three core stability measures: timestamps, WCAG structure and the Four Laws. It respects your device's light/dark display settings, and includes a full Help/About panel with usage instructions and keyboard shortcuts. I routinely use this simple clipboard-based tool to successfully produce stable, multi-hour sessions spanning dozens of turns with little to no hallucination, drift or unwanted behavior.

*(The "light mode" screenshots on this page show the PowerShell version, which is no longer in active development but remains available. The dark mode image is of the cross-platform Python/PyQt6 version (CORE), functional in Windows and Linux. Its larger download size reflects the cleaner and more consistent aesthetics, added QoL features and a bundled Python runtime — the same three-function workflow and full WCAG 2.2 AA compliance still applies on both platforms.)*
