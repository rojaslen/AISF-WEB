...
<figure class="screenshot float-right">
  ...
  <figcaption>1. Help / About panel, resized<br>(PowerShell, light mode).</figcaption>
</figure>
...
<figure class="screenshot float-right">
  ...
  <figcaption>2. CORE app (dark mode)</figcaption>
</figure>
...
<figure class="screenshot float-right">
  ...
  <figcaption>3. CORE app<br>(PowerShell, light mode)</figcaption>
</figure>
...
<figure class="screenshot float-right">
  ...
  <figcaption>4. CORE+ app (dark mode)</figcaption>
</figure>
...
<figure class="screenshot float-right">
  ...
  <figcaption>5. FFE on ChatGPT, Turn 1<br>(rules visible in log)</figcaption>
</figure>Supported platforms:
...
<a href="/apx01-downloads">The download page</a> provides the full Micro-layer client implementations.
