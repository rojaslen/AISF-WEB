...
If the app-switching copy-paste workflow friction is too much hassle, you can completely skip it with the **FFE Firefox extension.** A web-hosted Meso-layer demo (requiring no Micro-layer client intervention at all) is also under development; details on both follow.
