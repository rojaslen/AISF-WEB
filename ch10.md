...
Standardized add-on module packages are under development; for made-to-order commissions, inquire via the email address in page footer. Module functionality is currently only available with CORE+ (Windows/Linux); porting to other Framework apps is planned.</I></blockquote>
