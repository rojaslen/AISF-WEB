...
- **A browser extension for five platforms.** Claude, ChatGPT, Gemini, Copilot, Duck.ai. Automates injection with no per-session manual setup. Signed and ready to install, also **free for personal use.**
