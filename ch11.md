...
The feasibility of training AI Stability Framework principles directly into a locally-hosted model is established. The real question is whether it can work for large cloud-hosted frontier models with substantially different architectures? That remains an open question, due to the limits of my resources. What I can say is that the architecture seems to matter more than the raw parameter count. What that means at frontier scales is unclear.
